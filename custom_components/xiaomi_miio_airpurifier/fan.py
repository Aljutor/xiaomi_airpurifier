...
PURIFIER_MIOT = [MODEL_AIRPURIFIER_3, MODEL_AIRPURIFIER_3H, MODEL_AIRPURIFIER_ZA1, MODEL_AIRPURIFIER_4]
...
OPERATION_MODES_AIRPURIFIER_4 = ["Auto", "Sleep", "Favorite", "Manual"]
